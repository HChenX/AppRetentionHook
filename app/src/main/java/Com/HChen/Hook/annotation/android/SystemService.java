...
import static Com.HChen.Hook.param.classpath.SystemName.ActiveServices;
...
import static Com.HChen.Hook.param.classpath.SystemName.ActivityManagerService$LocalService;
import static Com.HChen.Hook.param.classpath.SystemName.AppProfiler;
import static Com.HChen.Hook.param.classpath.SystemName.CachedAppOptimizer;
import static Com.HChen.Hook.param.classpath.SystemName.LowMemDetector;
import static Com.HChen.Hook.param.classpath.SystemName.LowMemDetector$LowMemThread;
import static Com.HChen.Hook.param.classpath.SystemName.ProcessList;
import static Com.HChen.Hook.param.classpath.SystemName.ProcessProfileRecord;
...
import static Com.HChen.Hook.param.name.SystemValue.checkExcessivePowerUsage;
import static Com.HChen.Hook.param.name.SystemValue.getAppStartModeLOSP;
import static Com.HChen.Hook.param.name.SystemValue.getBinderFreezeInfo;
import static Com.HChen.Hook.param.name.SystemValue.isKilledByAm;
import static Com.HChen.Hook.param.name.SystemValue.killAllBackgroundProcesses;
import static Com.HChen.Hook.param.name.SystemValue.killAllBackgroundProcessesExcept;
import static Com.HChen.Hook.param.name.SystemValue.killAllBackgroundProcessesExceptLSP;
...
import static Com.HChen.Hook.param.name.SystemValue.killProcessesBelowForeground;
import static Com.HChen.Hook.param.name.SystemValue.run;
import static Com.HChen.Hook.param.name.SystemValue.setMemFactorOverride;
import static Com.HChen.Hook.param.name.SystemValue.setOomAdj;
import static Com.HChen.Hook.param.name.SystemValue.setOverrideMaxCachedProcesses;
import static Com.HChen.Hook.param.name.SystemValue.setProcessMemoryTrimLevel;
import static Com.HChen.Hook.param.name.SystemValue.shouldNotKillOnBgRestrictedAndIdle;
import static Com.HChen.Hook.param.name.SystemValue.stopInBackgroundLocked;
import static Com.HChen.Hook.param.name.SystemValue.trimApplicationsLocked;
import static Com.HChen.Hook.param.name.SystemValue.trimMemoryUiHiddenIfNecessaryLSP;
import static Com.HChen.Hook.param.name.SystemValue.updateBackgroundRestrictedForUidPackageLocked;
import static Com.HChen.Hook.param.name.SystemValue.updateKillBgRestrictedCachedIdle;
import static Com.HChen.Hook.param.name.SystemValue.updateLowMemStateLSP;
import static Com.HChen.Hook.param.name.SystemValue.waitForPressure;
