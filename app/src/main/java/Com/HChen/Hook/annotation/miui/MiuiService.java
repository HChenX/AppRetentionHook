...
import static Com.HChen.Hook.param.classpath.MiuiName.MiuiMemReclaimer;
import static Com.HChen.Hook.param.classpath.MiuiName.MiuiMemReclaimer$CompactorHandler;
import static Com.HChen.Hook.param.classpath.MiuiName.MiuiMemoryService;
import static Com.HChen.Hook.param.classpath.MiuiName.MiuiMemoryService$ConnectionHandler;
import static Com.HChen.Hook.param.classpath.MiuiName.MiuiMemoryService$MiuiMemServiceThread;
import static Com.HChen.Hook.param.classpath.MiuiName.PeriodicCleanerService$MyHandler;
import static Com.HChen.Hook.param.classpath.MiuiName.PeriodicCleanerService$PeriodicShellCmd;
...
import static Com.HChen.Hook.param.classpath.MiuiName.ProcessMemoryCleaner$H;
...
import static Com.HChen.Hook.param.classpath.MiuiName.SmartCpuPolicyManager;
import static Com.HChen.Hook.param.name.MiuiValue.checkBackgroundProcCompact;
import static Com.HChen.Hook.param.name.MiuiValue.handleLimitCpuException;
import static Com.HChen.Hook.param.name.MiuiValue.handleMessage;
import static Com.HChen.Hook.param.name.MiuiValue.isEnableResumeFeature;
import static Com.HChen.Hook.param.name.MiuiValue.run;
import static Com.HChen.Hook.param.name.MiuiValue.runClean;
