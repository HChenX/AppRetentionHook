 ...
 */
package Com.HChen.Hook.annotation.miui;

import static Com.HChen.Hook.param.classpath.Miui.GameMemoryCleaner;
import static Com.HChen.Hook.param.classpath.Miui.MiuiMemReclaimer;
import static Com.HChen.Hook.param.classpath.Miui.MiuiMemReclaimer$CompactorHandler;
import static Com.HChen.Hook.param.classpath.Miui.MiuiMemoryService;
import static Com.HChen.Hook.param.classpath.Miui.MiuiMemoryService$ConnectionHandler;
import static Com.HChen.Hook.param.classpath.Miui.MiuiMemoryService$MiuiMemServiceThread;
import static Com.HChen.Hook.param.classpath.Miui.PeriodicCleanerService$MyHandler;
import static Com.HChen.Hook.param.classpath.Miui.PeriodicCleanerService$PeriodicShellCmd;
import static Com.HChen.Hook.param.classpath.Miui.PreloadAppControllerImpl;
import static Com.HChen.Hook.param.classpath.Miui.PreloadLifecycle;
import static Com.HChen.Hook.param.classpath.Miui.ProcessMemoryCleaner;
import static Com.HChen.Hook.param.classpath.Miui.ProcessMemoryCleaner$H;
...
import static Com.HChen.Hook.param.classpath.Miui.SmartCpuPolicyManager;
import static Com.HChen.Hook.param.method.Miui.checkBackgroundProcCompact;
import static Com.HChen.Hook.param.method.Miui.handleLimitCpuException;
import static Com.HChen.Hook.param.method.Miui.handleMessage;
import static Com.HChen.Hook.param.method.Miui.isEnableResumeFeature;
import static Com.HChen.Hook.param.method.Miui.run;
import static Com.HChen.Hook.param.method.Miui.runClean;
import static Com.HChen.Hook.param.method.Miui.startPreloadApp;
